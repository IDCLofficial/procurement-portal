...
export default function ContractorDetails({ contractor }: ContractorDetailsProps) {
    ...
    const verificationUrl = typeof window !== 'undefined' 
        ? `${"http://192.168.59.98:3000"}/contractor/${contractor.id}?scan=true`
        ...
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="hover:shadow-lg transition-shadow duration-300">
                    <CardContent className="pt-6">
                        <div className="flex items-center gap-2 mb-5">
                            <h2 className="text-xl font-semibold text-gray-900/70">Company Information</h2>
                        </div>
                ...
                <Card className="hover:shadow-lg transition-shadow duration-300">
                    <CardContent className="pt-6">
                        <div className="flex items-center gap-2 mb-5">
                            <h2 className="text-xl font-semibold text-gray-900/70">Contact Information</h2>
                        </div>
                        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                    <CardContent className="pt-6">
                        <h2 className="text-xl font-semibold mb-4 opacity-70">Registration Status</h2>
                        <div className="space-y-4">
                            <div>
            ...
            <Card className={
                ...
                <CardContent className="pt-6">
                    <div className="flex items-start gap-4">
                        <div className={`w-12 h-12 aspect-square border border-gray-100 rounded-full flex items-center justify-center ${
                            contractor.status === 'approved'
                                ? 'bg-green-200/80'
                                : contractor.status === 'pending'
                                ? 'bg-yellow-200/80'
